---
title: "Run EGRET with no Expression and PPI message passing - GM12878"
...
Running EGRET (*without Expr data and PPI data*) on GM12878.
...
tag <- "finalEGRET_v1_noExpr_noPPI_gm12878"
```
...
Individual inputs:
```{r individual_inputs}
qbic <- read.table(file = "../inputs/qb", header = FALSE)
