...
library(precrec)
library(ggplot2)
tag <- "finalEgret_v1_GM12878_allModels_smart3_06302020"
...
files <- c("finalEgret_v1_na12878_allModels_smart3_07012020_egret.RData")
...
load("../outputs/validation_table_finalEgret_v1_GM12878_allModels_smart3_06302020.RData")
```
...
egret_priors <- c(1)
thresholds <- c(0.1, 0.15, 0.2, 0.25, 0.5, 0.75,1,1.5,2,2.5)
...
numEdges <- c(10,20,30,40,50,60,100, 110,120,130,140,150,160,200)
