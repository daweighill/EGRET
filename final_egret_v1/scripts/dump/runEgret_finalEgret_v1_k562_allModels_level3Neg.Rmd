---
title: "Run final Egret v1 - K562 (all QBiC models, level3Neg)"
...
Running finalEgret on K562 - all QBiC models, level 3Neg filtering
...
tag <- "finalEgret_v1_k562_allModels_level3Neg_06292020"
```
...
qbic <- read.table(file = "../inputs/qbic_eQTLS_GM12878_K562_finalEGRET_v1_06252020_allModels_level3Neg.txt", header = FALSE)
