---
title: "Run final Egret v1 - K562 (all QBiC models, level2BI"
...
Running caEGRET v3.1 on K562 using only eQTLs, no caQTLs
...
tag <- "finalEgret_v1_k562_allModels_level2Bi_06292020"
```
...
qbic <- read.table(file = "../inputs/qbic_eQTLS_GM12878_K562_finalEGRET_v1_06252020_allModels_level2Bi.txt", header = FALSE)
