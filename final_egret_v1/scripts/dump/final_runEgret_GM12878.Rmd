...
#individual qbic results eQTLs - these are qbic results of qtls which are (1) in motifs within the promotor region of genes (2) for eQTLs, the eGene is the adjacent gene, (3) the vcf file of the individual(s) in question contains the QTL as an alternate allele and (4) the qbic effect is negative, is predicted from human pbms and predicts a change in binding.
