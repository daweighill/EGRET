...
Running finalEgret v1 (*without PPI data*) on GM12878.
...
tag <- "finalEgret_v1_noPPI_na12878_06192020"
```
...
mclapply(processes, function(p) {
  system.time(results <- panda(as.data.frame(prior_list[p]), expr=clean_data, ppi=NULL,progress=TRUE, remove.missing.ppi = TRUE, remove.missing.motif = TRUE, remove.missing.genes = TRUE))
