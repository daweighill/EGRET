...
Running finalEgret v1 on K562 using all Qbic models
...
tag <- "finalEgret_v1_k562_allModels_noPPI_noExp_06252020"
```
...
qbic <- read.table(file = "../inputs/qbic_eQTLS_GM12878_K562_finalEGRET_v1_06252020_allModels.txt", header = FALSE)
