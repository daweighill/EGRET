...
library(precrec)
library(ggplot2)
tag <- "finalEgret_v1_GM12878_allModels_smart6_07012020"
...
files <- c("finalEgret_v1_na12878_allModels_smart6_07012020_egret.RData")
...
egret_priors <- c(1)
thresholds <- c(0.1, 0.15, 0.2, 0.25,0.3,0.35,0.4, 0.5, 0.75,1,1.5,2,2.5,3,4)
