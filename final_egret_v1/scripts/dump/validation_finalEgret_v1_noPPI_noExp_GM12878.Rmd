---
title: "Final EGRET v1 validation: GM12878 no PPI no Exp"
...
library(precrec)
library(ggplot2)
tag <- "finalEgret_v1_noExp_noPPI_GM12878_06222020"
...
load("../outputs/finalEGRET_v1_noExpr_noPPI_na12878_06222020_panda.RData")
net <- melt(regnet)
...
files <- c("finalEGRET_v1_noExpr_noPPI_na12878_06222020_egret.RData")
