...
tag <- "finalEgret_v1_na12878_mouseFly_smart4_07012020"
```
...
qbic <- read.table(file = "../inputs/qbic_eQTLS_GM12878_K562_finalEGRET_v1_06302020_mouseFly_smart4.txt", header = FALSE)
