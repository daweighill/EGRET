---
title: "Final EGRET v1 validation: GM12878 with with Mouse, no PPI and Exp"
...
library(precrec)
library(ggplot2)
tag <- "finalEgret_v1_withMouse_noPPIExp_GM12878_06292020"
...
load("../outputs/finalEgret_v1_na12878_withMouse_noPPI_noExp_06292020_panda.RData")
net <- melt(regnet)
...
files <- c("finalEgret_v1_na12878_withMouse_noPPI_noExp_06292020_egret.RData")
