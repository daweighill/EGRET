...
tag <- "finalEgret_v1_onlyQbic_na12878_06192020"
```
...
#individual qbic results for alternate alleles in the individual - these are qbic results of SNPs which are (1) in motifs within the promotor region of genes (2) in the vcf file of the individual(s) in question 
qbic <- read.table(file = "../inputs/qbic_allSNPS_GM12878_K562_finalEGRET_v1_06182020.txt", header = FALSE)
...
#qtl <- read.table("../inputs/QTLs_in_motif_promotor_adjacent_egene_caEGRET_v3.1_06102020.txt", header = FALSE)
