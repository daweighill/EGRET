...
Running finalEgret v1 on GM12878 with no caQTLs.
...
tag <- "finalEgret_v1_na12878_allModels_smart1_variant_07022020"
```
...
combined$variantMod <- ifelse(combined$absQtlQffect_altAlleleCount_qbicEffect ==0, 0, 1)
combined$egretPrior <- combined$edgeP - combined$variantMod

egretPrior <- combined[,c(1,2,7)]
