...
tag <- "finalEgret_v1_na12878_allModels_smart6_07012020"
```
...
qbic <- read.table(file = "../inputs/qbic_eQTLS_GM12878_K562_finalEGRET_v1_06302020_allModels_smart6.txt", header = FALSE)
