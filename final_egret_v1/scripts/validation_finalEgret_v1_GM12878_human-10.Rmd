...
library(precrec)
library(ggplot2)
tag <- "finalEgret_v1_GM12878_human-10_validation_07032020"
...
files <- c("finalEgret_v1_na12878_human-10_07032020_egret.RData")
...
egret_priors <- c(1)
thresholds <- c(0.1, 0.15, 0.2, 0.25,0.3,0.4, 0.5, 0.75,1,1.5,2,2.5)
...
egret_priors <- c(1)
numEdges <- c(10,15,20,25,30,35,40,45,50,55,60,65,70,80,90,100)
