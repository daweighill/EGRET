...
tag <- "EGRET_allQBiCModels_gm12878_sensitivity_eqtl_1e-6_08202021"
...
qtl <- read.table("../inputs/eQTL_1e-06_in_motif_promotor_adjacent_egene_sensitivity_08182021.txt", header = FALSE)
