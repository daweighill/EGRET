...
library(precrec)
library(ggplot2)
tag <- "finalEgret_v1_allModels_GM12878_06292020"
...
files <- c("finalEgret_v1_na12878_allModels_06242020_egret.RData")
...
```{r}
load("../outputs/validation_table_finalEgret_v1_allModels_GM12878_06292020.RData")
