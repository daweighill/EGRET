...
save(alpaca_score_table_iPSCCM, file = "../alpaca/iPSC-CM_alpaca_score_table_TFs_genes.RData")
```
...
cads <- merged_alpaca_table_scaled[which(merged_alpaca_table_scaled$node %in% only_CAD_genes),c(1:358)]
