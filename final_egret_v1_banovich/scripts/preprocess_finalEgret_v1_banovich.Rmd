---
title: "Final EGRET v1 Banovich - Application to Banovich data"
...
We use motif data from ~/EGRET/final_egret_v1/
...
## LCL
These are WASP + qqnorm proccessed, as shown on the website we got the data 
http://eqtl.uchicago.edu/jointLCL/
```{r}
...
## iPSC-CM
Note - These are also WASP processed, but they are raw counts sas detailed in the series matrix file from GEO https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE107654. We need to standardize the rows (genes) and qqnorm the columns (individuals).
```{r}
